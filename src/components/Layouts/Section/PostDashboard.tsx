...
import { makeDataPost, Post } from 'src/components/Elements/Table/makeDataPost';
...
import { PostType, OptionData } from '@/utils/types';
...
const PostDashboard: React.FC = () => {
  ...
  const columns = React.useMemo<ColumnDef<Post, any>[]>(
    () => [
      {
        header: 'Posts',
  ...
  const [data, setData] = React.useState<Post[]>(() => makeDataPost(1000))
  const refreshData = () => setData(old => makeDataPost(1000))
